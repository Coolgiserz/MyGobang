...
public class LabelListener implements ActionListener, ChangeListener {
	...
	public static String ai_mode = MODE_AISECOND;
...
//		System.out.println(e.getSource());
		...
		case BTN_BEGIN:
			...
			CanvasListener.turnState= CanvasListener.BLACK_SIDE;
			CanvasListener.initChessTable();
//			this._buttyChessPanel.validate();
			long start = System.currentTimeMillis();
			CoolFrame.chesscanvas.repaint();
//			this._buttyChessPanel.paintImmediately(0, 0, 1000, 1000);
			long end = System.currentTimeMillis();
			System.out.println("重新开始按钮执行时间："+(end-start));

//			this._buttyChessPanel.repaint();//重绘会延迟
...
//					this._buttyChessPanel.validate();
					...
					this._canvasLis._chesstable[p.x][p.y] = 0;
					CoolFrame.chesscanvas.repaint();

					this._buttyChessPanel.paintImmediately(0, 0, 1000, 1000);
					CanvasListener.turnState = -CanvasListener.turnState;
					 end = System.currentTimeMillis();

					System.out.println("悔棋执行时间："+(end-start));
